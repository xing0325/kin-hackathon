...
| --- | --- | --- | --- |
| 项目及团队介绍 | 🟡 基本完成 | README 已包含问题、用户、场景、核心体验和工作流分工 | 补团队成员姓名/头像/每人一句职责；压缩为一页 |
| 三分钟 Demo 视频 | 🔴 未见最终文件/链接 | `docs/DEMO_SCRIPT.md`、真实双机 PASS 记录 | 按脚本录一条 60–90 秒连续双机镜头，再补架构讲解和字幕 |
...
**最快路径：** 用 README 的“团队分工”表做底稿，只补姓名，不再扩写产品背景；控制在一页。
