...
class CardputerKeyboard {
 public:
  bool begin() {
    ...
    ok_ = M5.In_I2C.writeRegister8(0x34, 0x01, 0x01, 400000);
    ok_ = ok_ && M5.In_I2C.writeRegister8(0x34, 0x1D, 0x7F, 400000);
    ok_ = ok_ && M5.In_I2C.writeRegister8(0x34, 0x1E, 0xFF, 400000);
    ok_ = ok_ && M5.In_I2C.writeRegister8(0x34, 0x1F, 0xFF, 400000);
    ok_ = ok_ && M5.In_I2C.writeRegister8(0x34, 0x02, 0x01, 400000);
    return ok_;
  }
